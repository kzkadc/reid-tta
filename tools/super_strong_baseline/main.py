# https://github.com/open-mmlab/OpenUnReID/blob/master/tools/super_strong_baseline/main.py
    ...
    def update_labels(self):
        ...
        for idx, set in enumerate(self.train_sets):
            if idx in self.cfg.TRAIN.unsup_dataset_indexes:
                ...
                num_memory += self.cfg.TRAIN.PSEUDO_LABELS.cluster_num[self.cfg.TRAIN.unsup_dataset_indexes.index(
                    idx)]
            else:
